...
-- Fix Function Search Paths and Security Definer Views (Skip materialized view RLS for now)
...
-- Drop and recreate active_queries view
...
-- Drop and recreate table_sizes view
...
-- Drop and recreate job_queue_health view
...
-- Drop and recreate index_usage view
...
-- Drop and recreate organization_stats view 
...
COMMENT ON VIEW public.active_queries IS 'Administrative view: Currently executing database queries';
COMMENT ON VIEW public.table_sizes IS 'Administrative view: Table size information';
COMMENT ON VIEW public.job_queue_health IS 'Administrative view: Job processing statistics';
COMMENT ON VIEW public.index_usage IS 'Administrative view: Index usage statistics';
COMMENT ON VIEW public.organization_stats IS 'Organization metrics view';

-- Log the security improvements
SELECT public.log_security_event(
    'security_definer_views_fixed',
    'database_migration',
    'simplified_security_fixes',
    true,
    'Fixed 5 Security Definer Views and 2 Function Search Path issues'
);