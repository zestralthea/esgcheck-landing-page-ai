-- Fix the migration by creating a function instead of a view for access summary

-- Remove the problematic view and its policy
DROP POLICY IF EXISTS "Users can view summary of their own documents" ON public.document_access_summary;
DROP VIEW IF EXISTS public.document_access_summary;

-- Create a function to get document access summary instead
