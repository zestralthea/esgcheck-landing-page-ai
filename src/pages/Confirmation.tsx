  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,hsl(var(--background))_0%,hsl(var(--secondary))_100%)]">
      ...
      <main className="mx-auto flex min-h-screen w-full max-w-5xl items-center justify-center px-4 py-8 md:py-12">
        <m.section
          className="w-full max-w-3xl overflow-hidden rounded-2xl border border-border/80 bg-card px-6 py-10 text-center shadow-elegant sm:px-10 md:px-14 md:py-12"
          initial="hidden"
          animate="visible"
          variants={revealUp}
